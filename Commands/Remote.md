...
When working with git, a **remote** is any git repository that is not on the machine you're wokring on. the counterpart to the is **local**, or the machine that is being developed on.
